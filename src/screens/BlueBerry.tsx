...
function BlueBerry({ onScreenChange }: BlueBerryProps): JSX.Element {
  const donutName = "BlueBerry";
  const donutColor = "#4ABAF0";
  const donutBg = "#DEF7FF";
  ...
  return (
    ...
    >
      <Header color={donutColor} logo={logo2} />
